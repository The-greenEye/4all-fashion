...
function loopApiLink(pl) {
  ...
  productAryy += `
      ...
      <div class="container" onmousemove="localnumber(muplace.value)">
                  ...
                  <div class="flex-w flex-r-m p-b-10">
                    <div class="size-204 flex-w flex-m respon6-next">
                      <div class="wrap-num-product flex-w m-r-20 m-tb-10">
                        <input class="mtext-104 cl3 txt-center num-product w-100" type="number" name="num-product" value="1" id="muplace" />
                      </div>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
          <div class="block2">
            ...
            <div class="block2-txt flex-w flex-t p-t-14">
              ...
              <div class="block2-txt-child2 flex-r p-t-3">
                <img class="icon-heart1 dis-block trans-04" style="cursor:pointer;" onclick="getwish(${i + 1},this)" src="images/icons/icon-heart-01.png" alt="ICON" />
              </div>
            </div>
          </div>
        </div>
